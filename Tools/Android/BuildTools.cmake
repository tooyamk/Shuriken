...
set(OpenJDKUrlBase https://builds.openlogic.com/downloadJDK/openlogic-openjdk/8u362-b09/openlogic-openjdk-8u362-b09-)
...
if (${os} MATCHES "windows")
    if (IS_64Bit)
        ...
        set(OpenJDKUrl ${OpenJDKUrlBase}windows-x32.zip)
    endif ()
...
elseif (${os} MATCHES "linux")
    if (IS_64Bit)
        ...
        set(OpenJDKUrl ${OpenJDKUrlBase}linux-x32.tar.gz)
    endif ()
...
elseif (${os} MATCHES "darwin")
    set(OpenJDKUrl ${OpenJDKUrlBase}mac-x64.zip)
