...
namespace srk {
	size_t ThreadUtility::calcNeedCount(size_t jobCount, size_t leastJobsPerThread, size_t maxThreadCount) {
	...
	ThreadUtility::JobRange ThreadUtility::calcJobRange(size_t jobCount, size_t threadCount, size_t threadIndex) {
