...
#	define SRK_EXTENSION_HID_ENUM_HIDReportGenericDesktopPageType \
			...
			SRK_EXTENSION_HID_ENUM_ELEMENT(VX, 0x40) \
			SRK_EXTENSION_HID_ENUM_ELEMENT(VY, 0x41) \
			SRK_EXTENSION_HID_ENUM_ELEMENT(VZ, 0x42) \
			SRK_EXTENSION_HID_ENUM_ELEMENT(VBRX, 0x43) \
			SRK_EXTENSION_HID_ENUM_ELEMENT(VBRY, 0x44) \
			SRK_EXTENSION_HID_ENUM_ELEMENT(VBRZ, 0x45) \
			SRK_EXTENSION_HID_ENUM_ELEMENT(VNO, 0x46) \
			SRK_EXTENSION_HID_ENUM_ELEMENT(FEATURE_NOTIFICATION, 0x47) \
			SRK_EXTENSION_HID_ENUM_ELEMENT(RESOLUTION_MULTIPLIER, 0x48) \
			SRK_EXTENSION_HID_ENUM_ELEMENT(QX, 0x49) \
			SRK_EXTENSION_HID_ENUM_ELEMENT(QY, 0x4A) \
			SRK_EXTENSION_HID_ENUM_ELEMENT(QZ, 0x4B) \
			SRK_EXTENSION_HID_ENUM_ELEMENT(QW, 0x4C) \
			...
			SRK_EXTENSION_HID_ENUM_ELEMENT(DPAD_UP, 0x90) \
			SRK_EXTENSION_HID_ENUM_ELEMENT(DPAD_DOWN, 0x91) \
			SRK_EXTENSION_HID_ENUM_ELEMENT(DPAD_RIGHT, 0x92) \
			SRK_EXTENSION_HID_ENUM_ELEMENT(DPAD_LEFT, 0x93) \
