...
#	define AE_GENERIC_INPUT_ENUM_HIDReportButtonPageType \
			AE_GENERIC_INPUT_ENUM_ELEMENT(NO_BUTTON_PRESED, 0x0) \
			AE_GENERIC_INPUT_ENUM_ELEMENT(BUTTON_1, 0x1) \
			AE_GENERIC_INPUT_ENUM_ELEMENT(BUTTON_65535, 0xFFFF) \
...
#define AE_GENERIC_INPUT_ENUM_ELEMENT(a, b) a = b,
			AE_GENERIC_INPUT_ENUM_HIDReportButtonPageType
#undef AE_GENERIC_INPUT_ENUM_ELEMENT
		};
