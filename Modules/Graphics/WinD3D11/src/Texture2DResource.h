...
namespace aurora::modules::graphics::win_d3d11 {
	...
	public:
		...
		virtual bool AE_CALL create(const Size2<ui32>& size, ui32 arraySize, TextureFormat format, ui32 mipLevels, Usage resUsage, const void*const* data = nullptr) override;
		...
		virtual bool AE_CALL write(ui32 arraySlice, ui32 mipSlice, const Rect<ui32>& range, const void* data) override;
