...
namespace aurora::modules::graphics::win_d3d11 {
	class AE_MODULE_DLL Texture1D : public ITexture1D {
	public:
		Texture1D(Graphics& graphics);
		virtual ~Texture1D();

		virtual TextureType AE_CALL getType() const override;
		virtual void* AE_CALL getNative() const override;
		virtual bool AE_CALL allocate(ui32 width, TextureFormat format, ui32 mipLevels, Usage resUsage, const void*const* data = nullptr) override;
