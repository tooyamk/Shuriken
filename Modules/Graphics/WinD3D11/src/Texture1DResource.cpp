...
namespace aurora::modules::graphics::win_d3d11 {
	...
	bool Texture1DResource::create(ui32 width, ui32 arraySize, TextureFormat format, ui32 mipLevels, Usage resUsage, const void*const* data) {
		auto rst = _baseTexRes.create(_graphics.get<Graphics>(), TextureType::TEX1D, Vec3ui32({ width, 1, 1 }), arraySize, format, mipLevels, resUsage, data);
	...
	bool Texture1DResource::write(ui32 arraySlice, ui32 mipSlice, const Box1ui32& range, const void* data) {
		D3D11_BOX box;
