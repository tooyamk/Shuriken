...
namespace aurora::modules::graphics::win_d3d11 {
	...
	public:
		...
		virtual bool AE_CALL update(ui32 arraySlice, ui32 mipSlice, const Box3ui32& range, const void* data) override;
		virtual bool AE_CALL copyFrom(ui32 arraySlice, ui32 mipSlice, const Box3ui32& range, const IPixelBuffer* pixelBuffer) override;
