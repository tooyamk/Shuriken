...
namespace srk::modules::graphics::d3d11 {
	...
	public:
		...
		virtual bool SRK_CALL create(const Vec3uz& dim, size_t arraySize, size_t mipLevels, TextureFormat format, Usage requiredUsage, Usage preferredUsage, const void*const* data = nullptr);
