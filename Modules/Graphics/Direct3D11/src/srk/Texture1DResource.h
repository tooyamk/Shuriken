...
namespace srk::modules::graphics::d3d11 {
	...
	public:
		...
		virtual bool SRK_CALL create(size_t width, size_t arraySize, size_t mipLevels, TextureFormat format, Usage requiredUsage, Usage preferredUsage, const void*const* data = nullptr) override;
		...
		virtual bool SRK_CALL update(size_t arraySlice, size_t mipSlice, const Box1uz& range, const void* data) override;
